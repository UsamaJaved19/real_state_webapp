...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number =PhoneNumberField(verbose_name=_("Phone Number"),max_length=30,default="+92123456789")
    about_me = models.TextField(verbose_name=_("about me"),default="Say something about youself")
    licence = models.CharField(verbose_name=_("Licence"),max_length=20,blank=True,null=True)
    ...
    country  = CountryField(verbose_name=_("Country"), default="PK", blank=False, null= False)
    city = models.CharField(verbose_name=_("City"), max_length=25, default="Lahore", blank=False, null=False)
    is_buyer=models.BooleanField(verbose_name=_("Buyer"), default=False, help_text=_("Are you looking to buy a property"),)
    is_seller = models.BooleanField(verbose_name=_("Buyer"), default=False, help_text=_("Are you looking to sell a property"))
